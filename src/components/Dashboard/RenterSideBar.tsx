    ...
    <div className="relative font-Urbanist">
      ...
      >
        ...
        <a href="/" className="flex items-center space-x-3">
          <FaHome size={30} />
          {isOpen && <span className="text-lg font-bold">S<span className="text-purple-600">h</span>ebz</span>}
        </a>
...
function SidebarItem({ icon, text, isOpen }: { icon: JSX.Element; text: string; isOpen: boolean }) {
  return (
